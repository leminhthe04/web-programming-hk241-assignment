...
export default function ProductsManagement() {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost/Assignment/Backend//api/product/all",)
            .then((response) => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow justify-center" >
                <div className="w-full flex justify-end" onClick={() => { navigate("/admin/product-new") }}>
                    <div className="w-40 p-2 mt-10 font-bold add-product block bg-gray-300 h-10 hover:bg-slate-200 mr-20 justify-center text-center">Thêm sản phẩm</div>
                </div>
                <h2 className="text-bold">Chưa có sản phẩm để hiển thị</h2>
            </main>
            <Footer />
        </div>
    )
